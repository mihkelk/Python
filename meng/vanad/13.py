...
def collision_group():                  # uuendatakse ning joonistatakse k6ik platvormid nimekirjas platvormid, kokkupuutekontrolli kasutatakse platvormide uuenduses
    for i in range(len(platvormid)):
        platvormid[i].update()
        platvormid[i].draw()
#----------------------------------------------------------------------#
#-----------------------------Loomine----------------------------------#        
...
for i in range(platvorme):  # luuakse teatud hulk platvorme, trepina
    platvormid.append(i)
    platvormid[i] = sprite([(i+1) * 200,(i+1) * 50], platform_imag)
    
vasak_testiplatvorm = sprite([1,100], platform_imag)
ylemine_testiplatvorm = sprite([200,300], platform_imag)
platvormid.append(vasak_testiplatvorm)
platvormid.append(ylemine_testiplatvorm)  
#----------------------------------------------------------------------#
